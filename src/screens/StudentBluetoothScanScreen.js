      ...
      const fetchDeviceIds =
        async () => {
          try {
            ...
            console.error(
              'Error fetching device IDs:',
              error,
            );
            Alert.alert(
              'Error',
              'Failed to verify device. Please try again.',
            );
                        ...
                        if (
                          ...
                          try {
                            ...
                            if (
                              ...
                              throw new Error(
                                'Attendance marking returned false',
                              );
                            }
                          } catch (error) {
                            Alert.alert(
